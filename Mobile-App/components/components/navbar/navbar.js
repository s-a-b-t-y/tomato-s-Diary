  ...
  nav.innerHTML = `
    ...
    <div class="navbar__mobile-menu" role="dialog" aria-label="Mobile navigation">
      ...
      <div class="navbar__mobile-nav">
        ...
        <a href="#" class="navbar__mobile-link" id="mobileInstallGuideLink">
...
function initNavbar() {
  ...
  const mobileInstallGuideLink = navbar.querySelector('#mobileInstallGuideLink');
  if (mobileInstallGuideLink) {
    mobileInstallGuideLink.addEventListener('click', (e) => {
      e.preventDefault();
      showInstallGuide();
    });
  }
